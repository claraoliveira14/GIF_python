...
* **Escolha das imagens:** Criei a variável lista para o usuário poder escolher as imagens que quer para montar o GIF
* **Lista de Arquivos:** Criei uma lista (filenames) com o nome das imagens escolhidas, utilizando o .split(',') para separar arquivos diferentes e o .strip() para se o usuário digitar com o espaço após a vírgula.
...
* **Nome do arquivo:** Utilizei a variável new_name para o usuário poder escolher o novo nome do arquivo.
